...
class GetRoom(APIView):
    """The GetRoom view will take in the below data:
        -room's code
        -host's session
        -user's session"""
...
class CreateRoomView(APIView):
    """The GetRoom view will take in the below data:
        -room's code
        -host's session
        -room's sesttings (guest_can_pause and votes_to_skip)"""
...
class UserInRoom(APIView):
    """This API view is used to ensure user will always be routed back to joined/hosted room till 'leave room' on purpose
    data:
        -user's session
        -room's code"""
